...
namespace PozivNaBrojService
{
    public static class ModelPozivaService
    {
        ...
        public static ModelPoziva GetValidator(string model, string pozivNaBroj = null)
        {
            if (model.Length == 2)
                model = "HR" + model;
            ...
            if (!string.IsNullOrEmpty(pozivNaBroj) && pozivNaBroj.StartsWith("#Pivis#"))
                model = "HRxx";
